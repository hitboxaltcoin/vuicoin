...
"""Verify that starting vuicoind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vuicoind with -h for help text")
        ...
        self.log.info("Start vuicoind with -version for version information")
