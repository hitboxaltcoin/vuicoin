...
git clone https://github.com/hitboxaltcoin/dash
...
```bash
    ...
    From https://github.com/hitboxaltcoin/dash
...
[dash/gitian.sigs](https://github.com/hitboxaltcoin/gitian.sigs/) repository, or if that's not possible to create a pull
request.
