...
* vuicoin.conf: contains configuration settings for vuicoind or vuicoin-qt
* vuicoind.pid: stores the process id of vuicoind while running
...
* debug.log: contains debug information and general logging generated by vuicoind or vuicoin-qt
