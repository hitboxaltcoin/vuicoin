...
This document provides guidelines for internationalization of the Vuicoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vuicoin_en.ts` remains unchanged.
