// Copyright (c) 2018-2019 The Vuicoin Core developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef VUICOIN_CRYPTO_BLS_BATCHVERIFIER_H
#define VUICOIN_CRYPTO_BLS_BATCHVERIFIER_H
...
#endif //VUICOIN_CRYPTO_BLS_BATCHVERIFIER_H
