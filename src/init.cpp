...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/hitboxaltcoin/dash>";
        ...
        do {
            try {
                ...
                if (!fDisableGovernance && !fTxIndex
                   && chainparams.NetworkIDString() != CBaseChainParams::REGTEST) { // TODO remove this when pruning is fixed. See https://github.com/hitboxaltcoin/dash/pull/1817 and https://github.com/hitboxaltcoin/dash/pull/1743
