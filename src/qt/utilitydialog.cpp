    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  vuicoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Vuicoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 VUICOIN, 0.01 VUICOIN, 0.1 VUICOIN, 1 VUICOIN and 10 VUICOIN -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%1\" href=\"https://docs.vuicoin.org/en/stable/wallets/vuicoincore/privatesend-instantsend.html\">PrivateSend documentation</a>."
