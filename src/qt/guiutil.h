...
/** Utility functions used by the Vuicoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "vuicoin:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load vuicoin specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a vuicoin specific theme is activated (light/dark).*/
