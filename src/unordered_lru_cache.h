// Copyright (c) 2019-2020 The Vuicoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef VUICOIN_UNORDERED_LRU_CACHE_H
#define VUICOIN_UNORDERED_LRU_CACHE_H
...
#endif // VUICOIN_UNORDERED_LRU_CACHE_H
